...
2. **Token** — for protected endpoints (create via admin UI or `scripts/manage_tokens.py`)
...
- Token scope: tokens are managed via admin UI; some tokens may have limited access tiers
